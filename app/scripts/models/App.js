define(['backbone', 'Workspaces', 'Node', 'Login', 'Workspace', 'SearchElements', 'staticHelpers', 'Viewer', 'Storage'],
    function(Backbone, Workspaces, Node, Login, Workspace, SearchElements, helpers, Viewer, Storage){
